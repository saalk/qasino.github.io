...
licensing terms:
---------------------------------------------------------------------------
Vectorized Playing Cards 2.0 - http://sourceforge.net/projects/vector-playingCards/
...
https://sourceforge.net/p/vector-playingCards/wiki/Frequently_Asked_Questions/
...
http://sourceforge.net/projects/vector-playingCards/
Copyright 2015 - Chris Aguilar - conjurenation@gmail.com   
...
For .SVG capable editors (Inkscape and Illustrator CS2 tested)the playingCards are
...
containing various playingCard elements (pips, numbers,etc.) is included for those for
...
For Release 2.0 many new simple pattern backs and specialized playingCard faces sets
have been created, but these require the use of Inkscape.

A small set of ESP playingCards added.
__________________________
